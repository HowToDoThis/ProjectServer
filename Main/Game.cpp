...
void GameDLLInit(void)
{
	...
	CvarRegister(&sk_plr_9mm_bullet1);
	CvarRegister(&sk_plr_9mm_bullet2);
	CvarRegister(&sk_plr_9mm_bullet3);

	CvarRegister(&sk_plr_357_bullet1);
	CvarRegister(&sk_plr_357_bullet2);
	CvarRegister(&sk_plr_357_bullet3);

	CvarRegister(&sk_plr_9mmAR_bullet1);
	CvarRegister(&sk_plr_9mmAR_bullet2);
	CvarRegister(&sk_plr_9mmAR_bullet3);

	CvarRegister(&sk_plr_9mmAR_grenade1);
	CvarRegister(&sk_plr_9mmAR_grenade2);
	CvarRegister(&sk_plr_9mmAR_grenade3);

	CvarRegister(&sk_plr_buckshot1);
	CvarRegister(&sk_plr_buckshot2);
	CvarRegister(&sk_plr_buckshot3);

	CvarRegister(&sk_plr_rpg1);
	CvarRegister(&sk_plr_rpg2);
	CvarRegister(&sk_plr_rpg3);

	CvarRegister(&sk_12mm_bullet1);
	CvarRegister(&sk_12mm_bullet2);
	CvarRegister(&sk_12mm_bullet3);

	CvarRegister(&sk_9mmAR_bullet1);
	CvarRegister(&sk_9mmAR_bullet2);
	CvarRegister(&sk_9mmAR_bullet3);

	CvarRegister(&sk_9mm_bullet1);
	CvarRegister(&sk_9mm_bullet2);
	CvarRegister(&sk_9mm_bullet3);

	CvarRegister(&sk_suitcharger1);
	CvarRegister(&sk_suitcharger2);
	CvarRegister(&sk_suitcharger3);

	CvarRegister(&sk_battery1);
	CvarRegister(&sk_battery2);
	CvarRegister(&sk_battery3);

	CvarRegister(&sk_healthcharger1);
	CvarRegister(&sk_healthcharger2);
	CvarRegister(&sk_healthcharger3);

	CvarRegister(&sk_healthkit1);
	CvarRegister(&sk_healthkit2);
	CvarRegister(&sk_healthkit3);

	CvarRegister(&sk_scientist_heal1);
	CvarRegister(&sk_scientist_heal2);
	CvarRegister(&sk_scientist_heal3);
